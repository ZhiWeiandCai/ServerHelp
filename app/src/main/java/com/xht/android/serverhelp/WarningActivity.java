   ...
   private ArrayList<WaringItemBean> mListItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  for (int i=0;i<10;i++){
            ...
            item.setComName("小后台"+i);
            item.setTaskName("任务池"+i);
            item.setmAddress("南区");
            item.setmName("志伟");
            item.setmDaty("5天");
            item.setmTime("2016-1-20 17:20:30");
            mListItem.add(item);
        }
        for (int i=0;i<10;i++){
            WaringItemBean item=new WaringItemBean();
            ...
            item.setmAddress("东区");
            item.setmName("小众");
            item.setmTime("2016-5-3 17:44:30");
            item.setmDaty("8天");
            mListItem.add(item);
        }
        for (int i=0;i<10;i++){
            ...
            item.setComName("小后台"+i);
            item.setTaskName("任务池"+i);
            item.setmAddress("火炬区");
            item.setmName("上帝");
            item.setmDaty("15天");
            item.setmTime("2016-7-10 12:00:30");
            mListItem.add(item);
        }*/
